...
import { GET_TOOL_NAME, LIST_TOOL_NAME, type StorybookContext } from '@magicpatterns/storybook-mcp';
 ...
 * Extends StorybookContext to be compatible with @magicpatterns/storybook-mcp tools.
 */
