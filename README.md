...
- **[@magicpatterns/storybook-mcp](./packages/mcp)** - Standalone MCP library for serving Storybook component knowledge (can be used independently)
- **[@magicpatterns/storybook-mcp-addon](./packages/addon-mcp)** - Storybook addon that runs an MCP server within your Storybook dev server, and includes the functionality of **[@magicpatterns/storybook-mcp](./packages/mcp)** from your local Storybook
